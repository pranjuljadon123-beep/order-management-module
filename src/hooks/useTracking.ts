...
const mockShipments: Shipment[] = [
  ...
  {
    id: "7",
    containerId: "MAEU7728193",
    rfNumber: "RF-2026-004",
    carrier: { code: "MAEU", name: "Maersk" },
    origin: { port: "Yokohama, Japan", country: "Japan", countryCode: "JP" },
    destination: { port: "Long Beach, USA", country: "USA", countryCode: "US" },
    consignee: "Pacific_Tr...",
    carrierEta: "22 May 2026",
    prediction: { daysLate: 0 },
    status: "in-transit",
    isNew: true,
    progress: {
  ...
  {
    id: "8",
    containerId: "CMAU4429187",
    rfNumber: "RF-2026-005",
    carrier: { code: "CMAU", name: "CMA CGM" },
    origin: { port: "Le Havre, France", country: "France", countryCode: "FR" },
    destination: { port: "Santos, Brazil", country: "Brazil", countryCode: "BR" },
    consignee: "LatAm_Imp...",
    carrierEta: "30 May 2026",
    prediction: { daysLate: 4 },
    status: "delayed",
    isNew: true,
    progress: {
      emptyPickup: true,
    ...
    alert: "Vessel delayed at Algeciras transhipment hub due to port congestion. New ETA: 30 May 2026.",
    createdAt: new Date("2026-04-15"),
    updatedAt: new Date("2026-05-09"),
  },
  {
    id: "9",
    containerId: "ONEU5583092",
    rfNumber: "RF-2026-006",
    carrier: { code: "ONEU", name: "ONE" },
    origin: { port: "Ho Chi Minh City, Vietnam", country: "Vietnam", countryCode: "VN" },
    destination: { port: "Felixstowe, UK", country: "United Kingdom", countryCode: "UK" },
    consignee: "BritRetail...",
    carrierEta: "12 Jun 2026",
    prediction: { daysLate: 0 },
    status: "yet-to-start",
    isNew: true,
    progress: {
  ...
  {
    id: "10",
    containerId: "ZIMU3041826",
    rfNumber: "RF-2026-007",
    carrier: { code: "ZIMU", name: "ZIM" },
    origin: { port: "Haifa, Israel", country: "Israel", countryCode: "IL" },
    destination: { port: "Savannah, USA", country: "USA", countryCode: "US" },
    consignee: "EastCoast...",
    carrierEta: "02 May 2026",
    prediction: { daysLate: 0 },
    status: "completed",
    isNew: false,
    progress: {
