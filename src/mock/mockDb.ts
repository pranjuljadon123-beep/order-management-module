...
function seed(): Store {
  ...
  const orders = [
    { id: uid(), order_number: "ORD-2026-00001", status: "confirmed", order_type: "purchase_order", mode: "ocean_fcl", customer_id: customers[0].id, shipper_id: shippers[0].id, consignee_id: consignees[0].id, po_number: "PO-9821", commodity_description: "Electronics", total_value: 148500, risk_level: "low", version: 1, created_at: daysFromNow(-6), updated_at: nowIso() },
    { id: uid(), order_number: "ORD-2026-00002", status: "in_transit", order_type: "sales_order", mode: "ocean_fcl", customer_id: customers[1].id, shipper_id: shippers[1].id, consignee_id: consignees[1].id, po_number: "PO-9822", commodity_description: "Textiles", total_value: 87200, risk_level: "medium", version: 2, created_at: daysFromNow(-11), updated_at: nowIso() },
    { id: uid(), order_number: "ORD-2026-00003", status: "created", order_type: "purchase_order", mode: "air", customer_id: customers[2].id, shipper_id: shippers[2].id, consignee_id: consignees[2].id, po_number: "PO-9823", commodity_description: "Chemicals", total_value: 42100, risk_level: "high", version: 1, created_at: daysFromNow(-2), updated_at: nowIso() },
  ];
  const documents = [
