...
const solutionsData: Record<string, SolutionData> = {
  orders: {
    ...
    description: "Create, track, and manage orders across your entire operational workflow. Daistrix Order Management serves as the central system of record, connecting all downstream processes.",
    ...
    faqs: [
      ...
      { question: "Can we import existing orders from our ERP?", answer: "Yes, Daistrix supports bulk import from major ERP systems including SAP, Oracle, and Microsoft Dynamics. We also provide REST APIs and webhooks for real-time integration." },
  ...
  documents: {
    ...
    faqs: [
      { question: "What document types can be auto-generated?", answer: "Daistrix supports all common trade documents including commercial invoices, packing lists, certificates of origin, bills of lading, and customs declarations. You can also create custom templates for your specific needs." },
