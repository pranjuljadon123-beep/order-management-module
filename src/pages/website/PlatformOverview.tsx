        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 text-lg text-muted-foreground">
              Daistrix is the execution backbone for enterprise operations. We connect orders, documents, 
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="mb-8 text-lg text-muted-foreground">
                Daistrix provides the complete toolkit for enterprise operations teams. 
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 text-lg text-white/80">
              Schedule a personalized demo with our team and see how Daistrix can 
