        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            <h2 className="mb-4 text-3xl font-bold text-foreground lg:text-4xl">
              Why Enterprise Leaders Choose Daistrix
            </h2>
          ...
          <div className="rounded-2xl bg-gradient-to-r from-teal to-ocean p-8 lg:p-12">
            <div className="mx-auto mb-12 max-w-2xl text-center">
              ...
              <p className="text-lg text-white/80">
                Enterprise teams using Daistrix see transformative improvements across their operations.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 text-lg text-muted-foreground">
              See how Daistrix can become the execution backbone of your enterprise. 
