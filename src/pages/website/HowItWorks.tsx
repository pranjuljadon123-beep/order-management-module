        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 text-lg text-muted-foreground">
              From order creation to payment reconciliation, see how Daistrix connects 
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Daistrix integrates with your ERP, WMS, TMS, and carrier systems. 
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-4 text-3xl font-bold text-white lg:text-4xl">
              Ready to See Daistrix in Action?
            </h2>
            <p className="mb-8 text-lg text-white/80">
              Schedule a demo and see how Daistrix can transform your operations.
            </p>
